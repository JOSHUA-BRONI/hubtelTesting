...
//Testing if all the links on Request money from anyone page works
...
/*
  //Testing if links on Integrate Online Checkout page are working


  test('Check all Hubtel for Hospitals links excluding links with / or wrong format', async ({ page }) => {
    // Navigate to Hubtel for hospitals page
    await page.goto('https://explore.hubtel.com/integrate-online-checkout/');
